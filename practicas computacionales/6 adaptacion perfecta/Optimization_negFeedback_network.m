function Optimization_negFeedback_network
...
[t_opt,y_opt] = ode45(@(t,y)negative_feedback_network(t,y, k1, k2, k3, k4,S),tspan,y0);

Cost=CostFunction(x,S, t_exp, y_exp)

%figure();
hold on
plot(t_opt,y_opt(:,1), 'r',t_exp, y_exp, 'rd','MarkerSize', 10,'LineWidth',2)
...
% Call the ODE solver 
[t,y] = ode45(@(t,y)negative_feedback_network(t,y, k1, k2, k3, k4,S),tspan,y0);
